...
class Npc: public Actor {
    ...
    public:
        ...
        // Whenever wander_direction changes, wander_frequency is set to a new random value between wander_frequency_min
        // and wander_frequency_max.
        ...
        // The percentage chance that the npc will wander in a direction (versus pausing, using special attack, etc.)
        // when choosing a new wander state.
        short wander_weight;
        ...
        // The npc will then follow the player until a) the player dies, b) the npc dies, c) the player leaves the npc's
        // follow range.
        ...
        // If the player comes within special_attack_range_x and special_attack_range_y and any/all other special attack
        // conditions are met, the npc will use its special attack.
        // This range is in tiles.
        ...
        // Counter variable that keeps track of how many frames the npc has been attempting a special attack or chasing
        // the player.
        ...
        // Whenever a special attack is initiated, special_attack_pause_counter is set to special_attack_pause_length
        // and begins counting down to 0.
