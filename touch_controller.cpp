...
void Touch_Controller::render () {
    ...
    render_texture(anchor_dpad.x * scale_x - anchor_dpad.r * scale_mean,
                   anchor_dpad.y * scale_y - anchor_dpad.r * scale_mean, *image_dpad, touch_controller_opacity,
                   COLOR_WHITE, scale_anchor_dpad * scale_mean, scale_anchor_dpad * scale_mean);

    if (touch_controller_xy) {
        image_data* image_main = &image.touch_controller_main;

        render_texture(anchor_main.x * scale_x - anchor_main.r * scale_mean,
                       anchor_main.y * scale_y - anchor_main.r * scale_mean, *image_main, touch_controller_opacity,
                       COLOR_WHITE, scale_anchor_main * scale_mean, scale_anchor_main * scale_mean);
    } else {
    ...
    if (touch_controller_shoulders) {
        ...
        render_texture(shoulder_left.x * scale_x - shoulder_left.r * scale_mean,
                       ...
                       touch_controller_opacity, COLOR_WHITE, scale_shoulders * scale_mean,
                       scale_shoulders * scale_mean);
    ...
    if (touch_controller_guide) {
        ...
        render_texture(anchor_middle.x * scale_x, anchor_middle.y * scale_y, *image_middle, touch_controller_opacity,
                       COLOR_WHITE, scale_anchor_middle_x * scale_x, scale_anchor_middle_y * scale_y);
    } else {
