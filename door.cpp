        ...
        if (type == DOOR_TYPE_LOCAL) {
            ...
            if (open) {
                render_sprite((int) ((int) render_x - (int) player.camera_x),
                              (int) ((int) render_y - (int) player.camera_y), image.sprite_sheet_doors,
                              &sprites_doors[0][number]);
            }
            // If the door is closed.
            else {
                render_sprite((int) ((int) render_x - (int) player.camera_x),
                              (int) ((int) render_y - (int) player.camera_y), image.sprite_sheet_doors,
                              &sprites_doors[frame][number]);
            }
        } else if (type == DOOR_TYPE_KEY) {
            render_sprite((int) ((int) render_x - (int) player.camera_x),
                          (int) ((int) render_y - (int) player.camera_y), image.sprite_sheet_doors,
                          &sprites_key_doors[frame][number]);
        } else if (type == DOOR_TYPE_STANDARD) {
            render_sprite((int) ((int) render_x - (int) player.camera_x),
                          (int) ((int) render_y - (int) player.camera_y), image.sprite_sheet_door_standard,
                          &sprites_door_standard[frame]);
        }
    }
}
