...
special_info_return_data set_special_info_string (short special_info) {
    ...
    switch (special_info) {
        ...
        case SPECIAL_INFO_STAT_PERCENT_COMPLETE:
            ...
            top_n += player.check_inventory(ITEM_SWIMMING_GEAR) + player.check_inventory(ITEM_SUIT_DEADLY_WATER) +
                     player.check_inventory(ITEM_SUIT_SHARP) + player.check_inventory(ITEM_SUIT_BANANA);
            top_n += player.check_inventory(ITEM_SHOT_HOMING) + player.check_inventory(ITEM_TRANSLATOR) +
                     player.check_inventory(ITEM_J_WING);
        ...
        case SPECIAL_INFO_STAT_ENEMIES_STUNNED:
            ...
            ss.str("");
            ss << "Enemies blasted: ";
            ss << player.stat_enemies_stunned;
            text = ss.str();
            break;
        ...
        case SPECIAL_INFO_STAT_CHECKPOINTS_ACTIVATED:
            ss.clear();
            ss.str("");
            ss << "Checkpoints activated: ";
            ss << player.stat_checkpoints_activated;
            text = ss.str();
            break;
        ...
        case SPECIAL_INFO_STAT_AMMO_PICKED_UP:
            ss.clear();
            ss.str("");
            ss << "Ammo boxes collected: ";
            ss << player.stat_ammo_picked_up;
            text = ss.str();
            break;
        ...
        case SPECIAL_INFO_STAT_ACCURACY:
            ...
            if (player.stat_shots_fired > 0) {
                accuracy = 100 *
                           ((double) (player.stat_enemies_stunned + player.stat_triggers_shot) /
                            player.stat_shots_fired);
            }
        ...
        case SPECIAL_INFO_STAT_DEATHS_DROWNING:
            ss.clear();
            ss.str("");
            ss << "Deaths by drowning: ";
            ss << player.stat_deaths_drowning;
            text = ss.str();
            break;
        ...
        case SPECIAL_INFO_STAT_LEVELS_REPLAYED:
            ...
            ss.str("");
            ss << "Levels replayed: ";
            ss << player.stat_levels_replayed;
            text = ss.str();
            break;
        ...
        case SPECIAL_INFO_STAT_FARTHEST_FALL:
            ...
            ss.str("");
            ss << "Farthest fall: ";
            ss << player.stat_farthest_fall / 24;
            ss << " feet";
            text = ss.str();
            break;
        ...
        case SPECIAL_INFO_STAT_WATER_SHOT:
            ss.clear();
            ss.str("");
            ss << "Bodies of water assaulted: ";
            ss << player.stat_water_shot;
            text = ss.str();
            break;
        ...
        case SPECIAL_INFO_STAT_BOSSES_DEFEATED:
            ...
            ss.str("");
            ss << "Bosses defeated: ";
            ss << player.stat_bosses_defeated;
            text = ss.str();
            break;
        ...
        case SPECIAL_INFO_STAT_ITEMS_MOVED:
            ss.clear();
            ss.str("");
            ss << "Inventory items moved: ";
            ss << player.stat_items_moved;
            text = ss.str();
            break;
        ...
        case SPECIAL_INFO_LEVEL_STAT_LEAVES:
            ...
            if (which_window >= WHICH_WINDOW_LEVEL_INFO && which_window < WHICH_WINDOW_OTHER) {
                ...
                ss.str("");
                ss << "Leaves collected: ";
                ss << windows_level_info[which_window - WHICH_WINDOW_LEVEL_INFO].leaves;
                ss << "/";
                ss << windows_level_info[which_window - WHICH_WINDOW_LEVEL_INFO].leaves_max;
                text = ss.str();
            }
        ...
        case SPECIAL_INFO_LEVEL_STAT_CHEESE:
            ...
            if (which_window >= WHICH_WINDOW_LEVEL_INFO && which_window < WHICH_WINDOW_OTHER) {
                ...
                ss.str("");
                ss << "Cheese collected: ";
                ss << windows_level_info[which_window - WHICH_WINDOW_LEVEL_INFO].cheese;
                ss << "/";
                ss << windows_level_info[which_window - WHICH_WINDOW_LEVEL_INFO].cheese_max;
                text = ss.str();
            }
        ...
        case SPECIAL_INFO_ACHIEVEMENT + ACHIEVEMENT_PLAY_LEVEL_2_HOURS:
            ss.clear();
            ss.str("");
            ss << "Professor Jones, Archaeologist";
            text = ss.str();
            break;
        ...
        case SPECIAL_INFO_ACHIEVEMENT + ACHIEVEMENT_MENUS_1_HOUR:
            ss.clear();
            ss.str("");
            ss << "The Game is More Fun if You Click Play";
            text = ss.str();
            break;
        ...
        case SPECIAL_INFO_ACHIEVEMENT + ACHIEVEMENT_RIDE_COW_5_MINUTES:
            ss.clear();
            ss.str("");
            ss << "Having an Udderly Good Time";
            text = ss.str();
            break;
        ...
        case SPECIAL_INFO_ACHIEVEMENT + ACHIEVEMENT_WATER_SHOT_25:
            ss.clear();
            ss.str("");
            ss << "Seriously, Water Needs to Die";
            text = ss.str();
            break;
        ...
        case SPECIAL_INFO_ACHIEVEMENT + ACHIEVEMENT_JOKE_ITEM:
            ss.clear();
            ss.str("");
            ss << "Everything INCLUDING the Kitchen Sink";
            text = ss.str();
            break;
        ...
        case SPECIAL_INFO_ACHIEVEMENT + ACHIEVEMENT_VIEW_CREDITS:
            ss.clear();
            ss.str("");
            ss << "I'd Like to Thank the Little People";
            text = ss.str();
            break;
