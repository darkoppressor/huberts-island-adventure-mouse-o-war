...
class Moving_Platform {
    ...
    public:
        Moving_Platform (double get_move_speed, double get_start_x, double get_start_y, double get_end_x,
                         double get_end_y, std::vector<moving_platform_waypoint> get_waypoints, bool get_active,
        ...
        // False = Back and forth. When end point is reached, platform returns to start point via waypoints. When start
        // point is reached, platform returns to end point via waypoints.
        // True = Circular. When end point is reached, platform returns to start point directly. When start point is
        // reached, platform returns to end point via waypoints.
        bool movement_type;
