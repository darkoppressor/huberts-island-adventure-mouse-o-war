...
Window_Shop::Window_Shop (short get_x, short get_y, short get_w, short get_h, string get_title) {
    ...
    msg = "Purchase Toy";
    button_sound = 10 - 1;
    create_button(w - (msg.length() * font.spacing_x) - 16, h - back_button_space, "", msg, &button_event_shop_buy,
                  &sound_system.button_mouse_over[button_sound], &sound_system.button_event_fire[button_sound],
                  BUTTON_VISIBLE);
}
...
void Window_Shop::render () {
    if (on) {
        ...
        font.show(x + w - 15 - upgrade_string.length() * font.spacing_x, 40, upgrade_string,
