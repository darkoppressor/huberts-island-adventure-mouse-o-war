...
Window_Level_Info::Window_Level_Info (short get_x, short get_y, short get_w, short get_h, string get_title,
                                      int get_window_identifier, int get_level_identifier) {
