...
void render_rtt (double x, double y, Rtt_Data* rtt_source, double opacity, double scale_x, double scale_y, double angle,
                 short color_name, bool flip_x, bool flip_y) {
    SDL_Rect rect_dst;
...
void render_texture (double x, double y, image_data image_source, double opacity, short color_name, double scale_x,
                     double scale_y) {
    SDL_Rect rect_dst;
...
void render_sprite (double x, double y, image_data image_source, SDL_Rect* texture_clip, double opacity, double scale_x,
                    double scale_y, double angle, short color_name, bool flip_x) {
    SDL_Rect rect_src;
...
void render_rectangle_empty (double x, double y, double w, double h, double opacity, short color_name,
                             double line_width) {
