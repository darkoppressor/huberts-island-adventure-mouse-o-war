...
// All of the world variables are defined here. These include the level object (which stores much of the level's
// information, and has a function that handles loading of levels),
...
void set_change_profile_buttons () {
    ...
    vector_windows[WINDOW_CHANGE_PROFILE].create_button(360 - 23, 5, "", "X", &button_event_close_window, 0, 0,
                                                        BUTTON_VISIBLE, -1);

    vector_windows[WINDOW_CHANGE_PROFILE].create_information((360 - (16 * 12)) / 2, 40, "", "", 0,
                                                             SPECIAL_INFO_CURRENT_PROFILE);

    for (int i = 0; i < profile.profile_list.size(); i++) {
        vector_windows[WINDOW_CHANGE_PROFILE].create_information(15, 105 + 55 * i, "", "", 0,
                                                                 SPECIAL_INFO_PROFILE_1 + i);
        ...
        vector_windows[WINDOW_CHANGE_PROFILE].create_button(15, 130 + 55 * i, "", msg, &button_event_select_profile,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE, i);
        ...
        vector_windows[WINDOW_CHANGE_PROFILE].create_button(185, 130 + 55 * i, "", msg, &button_event_delete_profile,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE, i);
    }
    ...
    button_sound = 11 - 1;
    vector_windows[WINDOW_CHANGE_PROFILE].create_button((360 - (msg.length() * font.spacing_x)) / 2, 526, "", msg,
                                                        &button_event_open_window_create_profile,
                                                        &sound_system.button_mouse_over[button_sound],
                                                        &sound_system.button_event_fire[button_sound], BUTTON_VISIBLE);

    msg = "Back to Main Menu";
    button_sound = 12 - 1;
    vector_windows[WINDOW_CHANGE_PROFILE].create_button((360 - (msg.length() * font.spacing_x)) / 2, 563, "", msg,
                                                        &button_event_open_window_main_menu,
                                                        &sound_system.button_mouse_over[button_sound],
                                                        &sound_system.button_event_fire[button_sound], BUTTON_VISIBLE);
}
...
void create_hud_buttons () {
    ...
    button_sound = 12 - 1;
    hud_buttons.push_back(Button((main_window.SCREEN_WIDTH - (msg.length() * font.spacing_x)) / 2,
                                 main_window.SCREEN_HEIGHT - 35, "", msg, &button_event_skip_intro,
                                 &sound_system.button_mouse_over[button_sound],
                                 &sound_system.button_event_fire[button_sound], BUTTON_INVISIBLE, -1, BUTTON_DISABLED));
}
...
void create_windows () {
    ...
    window_inventory.push_back(Window_Inventory((main_window.SCREEN_WIDTH - 362) / 2,
                                                (main_window.SCREEN_HEIGHT - 398) / 2, 362, 398, "Inventory"));
    ...
    for (int i = 0; i < 16; i++) {
        ...
        windows_level_info.push_back(Window_Level_Info((main_window.SCREEN_WIDTH - window_width) / 2,
                                                       (main_window.SCREEN_HEIGHT - window_height) / 2, window_width,
                                                       window_height, msg, i, levels_with_info[i]));
        ...
        msg = "View Map";
        button_sound = 1 - 1;
        windows_level_info[windows_level_info.size() -
                           1].create_button((window_width - (msg.length() * font.spacing_x)) / 2, y_position, "", msg,
                                            &button_event_open_window_map_other_level,
                                            &sound_system.button_mouse_over[button_sound],
                                            &sound_system.button_event_fire[button_sound], BUTTON_VISIBLE,
                                            levels_with_info[i]);

        y_position += 40;
        windows_level_info[windows_level_info.size() - 1].create_information(250, y_position,
                                                                             "The number of leaves Hubert\nhas collected in this level.",
                                                                             "", 0, SPECIAL_INFO_LEVEL_STAT_LEAVES);

        y_position += 40;
        windows_level_info[windows_level_info.size() - 1].create_information(250, y_position,
                                                                             "The number of cheeses Hubert\nhas collected in this level.",
                                                                             "", 0, SPECIAL_INFO_LEVEL_STAT_CHEESE);

        y_position += 40;
        windows_level_info[windows_level_info.size() - 1].create_information(250, y_position,
                                                                             "The time Hubert has\nspent in this level.",
                                                                             "", 0, SPECIAL_INFO_LEVEL_STAT_TOTAL_TIME);

        y_position += 40;
        windows_level_info[windows_level_info.size() - 1].create_information(250, y_position,
                                                                             "Hubert's best time\nbeating this level.",
                                                                             "", 0, SPECIAL_INFO_LEVEL_STAT_BEST_TIME);

        msg = "< ";
        msg += level.return_level_name(levels_with_info[previous_window]);
        button_sound = 10 - 1;
        windows_level_info[windows_level_info.size() - 1].create_button(15, window_height - back_button_space, "", msg,
                                                                        &button_event_open_window_level_info,
                                                                        &sound_system.button_mouse_over[button_sound],
                                                                        &sound_system.button_event_fire[button_sound],
                                                                        BUTTON_VISIBLE, previous_window);

        msg = "Back to Main Menu";
        button_sound = 12 - 1;
        windows_level_info[windows_level_info.size() -
                           1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                            window_height - back_button_space, "", msg,
                                            &button_event_open_window_main_menu,
                                            &sound_system.button_mouse_over[button_sound],
                                            &sound_system.button_event_fire[button_sound], BUTTON_VISIBLE);
        ...
        msg += " >";
        button_sound = 11 - 1;
        windows_level_info[windows_level_info.size() - 1].create_button(window_width - 20 - msg.length() *
                                                                        font.spacing_x,
                                                                        window_height - back_button_space, "", msg,
                                                                        &button_event_open_window_level_info,
                                                                        &sound_system.button_mouse_over[button_sound],
                                                                        &sound_system.button_event_fire[button_sound],
                                                                        BUTTON_VISIBLE, next_window);
    }
    ...
    window_width = 300;
    window_height = 505;
    vector_windows.push_back(Window((main_window.SCREEN_WIDTH - window_width) / 2,
                                    (main_window.SCREEN_HEIGHT - window_height) / 2 + 40, window_width, window_height,
                                    "Main Menu", NO_SPECIAL_INPUT));

    vector_windows[vector_windows.size() - 1].create_information((window_width - (16 * 12)) / 2, 40, "", "", 0,
                                                                 SPECIAL_INFO_CURRENT_PROFILE);
    ...
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg,
                                                            &button_event_open_window_change_profile,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE, -1, BUTTON_DISABLED);
    ...
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg,
                                                            &button_event_open_window_select_game_mode,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    window_manager.main_menu_buttons_no_game.push_back(vector_windows[vector_windows.size() - 1].buttons.size() - 1);
    ...
    y_position += 30;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_open_window_level_info,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    window_manager.main_menu_buttons_no_game.push_back(vector_windows[vector_windows.size() - 1].buttons.size() - 1);
    ...
    y_position += 30;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_open_window_inventory,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    window_manager.main_menu_buttons_no_game.push_back(vector_windows[vector_windows.size() - 1].buttons.size() - 1);
    ...
    y_position += 30;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_open_window_stats,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    window_manager.main_menu_buttons_no_game.push_back(vector_windows[vector_windows.size() - 1].buttons.size() - 1);
    ...
    y_position += 30;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_open_window_achievements,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    window_manager.main_menu_buttons_no_game.push_back(vector_windows[vector_windows.size() - 1].buttons.size() - 1);
    ...
    y_position += 30;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_open_window_options,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    window_manager.main_menu_buttons_no_game.push_back(vector_windows[vector_windows.size() - 1].buttons.size() - 1);
    ...
    y_position += 30;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_open_window_help,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    window_manager.main_menu_buttons_no_game.push_back(vector_windows[vector_windows.size() - 1].buttons.size() - 1);
    ...
    y_position += 30;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_open_window_about,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    window_manager.main_menu_buttons_no_game.push_back(vector_windows[vector_windows.size() - 1].buttons.size() - 1);
    ...
    y_position += 30;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_open_window_credits,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    window_manager.main_menu_buttons_no_game.push_back(vector_windows[vector_windows.size() - 1].buttons.size() - 1);
    ...
    y_position += 30;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_quit,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    window_manager.main_menu_buttons_no_game.push_back(vector_windows[vector_windows.size() - 1].buttons.size() - 1);
    ...
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            ...
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE, -1, false);
    window_manager.main_menu_buttons_sp_adventure.push_back(vector_windows[vector_windows.size() - 1].buttons.size() -
                                                            1);
    msg = "Return to World Map";
    button_sound = 11 - 1;
    y_position += 45;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_return_to_world_map,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE, -1, false);
    ...
    y_position += 30;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_start_game,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE, -1, false);
    window_manager.main_menu_buttons_sp_adventure.push_back(vector_windows[vector_windows.size() - 1].buttons.size() -
    ...
    y_position += 30;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_end_game,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE, -1, false);
    window_manager.main_menu_buttons_sp_adventure.push_back(vector_windows[vector_windows.size() - 1].buttons.size() -
    ...
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            ...
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE, -1, false);
    window_manager.main_menu_buttons_mp_adventure.push_back(vector_windows[vector_windows.size() - 1].buttons.size() -
                                                            1);
    msg = "Return to World Map";
    button_sound = 11 - 1;
    y_position += 45;
    ...
    window_height = 400;
    vector_windows.push_back(Window((main_window.SCREEN_WIDTH - window_width) / 2,
                                    (main_window.SCREEN_HEIGHT - window_height) / 2, window_width, window_height,
                                    "Create Profile", SPECIAL_INPUT_CREATE_PROFILE));
    ...
    vector_windows[vector_windows.size() - 1].create_information((window_width - 16 * 12) / 2, 140, "",
                                                                 "Enter your name:", 0, NO_SPECIAL_INFO);

    vector_windows[vector_windows.size() - 1].create_information(15, 165, "", "", 0, SPECIAL_INFO_CREATING_PROFILE);

    msg = "Done";
    button_sound = 11 - 1;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2, 240,
                                                            "", msg, &button_event_create_profile,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows.push_back(Window((main_window.SCREEN_WIDTH - window_width) / 2,
                                    (main_window.SCREEN_HEIGHT - window_height) / 2, window_width, window_height,
                                    "Change Profile", NO_SPECIAL_INPUT));
    ...
    vector_windows.push_back(Window((main_window.SCREEN_WIDTH - window_width) / 2,
                                    (main_window.SCREEN_HEIGHT - window_height) / 2, window_width, window_height,
                                    "Stats", NO_SPECIAL_INPUT));

    y_position = 40;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The overall percentage of the game\nthat Hubert has completed.",
                                                                 "", 0, SPECIAL_INFO_STAT_PERCENT_COMPLETE);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The number of leaves Hubert\nhas collected, and the total number\nof leaves in the game.",
                                                                 "", 0, SPECIAL_INFO_STAT_LEAVES_COLLECTED);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The number of cheeses Hubert\nhas collected, and the total number\nof cheeses in the game.",
                                                                 "", 0, SPECIAL_INFO_STAT_CHEESE_COLLECTED);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The number of bosses\nHubert has defeated.", "", 0,
                                                                 SPECIAL_INFO_STAT_BOSSES_DEFEATED);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The time Hubert has\nspent playing the game.", "", 0,
                                                                 SPECIAL_INFO_STAT_SECONDS_PLAYING);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The time Hubert has\nspent traveling on the world map.",
                                                                 "", 0, SPECIAL_INFO_STAT_SECONDS_TRAVELING);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The time Hubert has\nspent in the menus.", "", 0,
    ...
    vector_windows[vector_windows.size() - 1].create_information(15, y_position, "Hubert's accuracy\nwith the stunner.",
                                                                 "", 0, SPECIAL_INFO_STAT_ACCURACY);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The number of times Hubert\nhas fired the stunner.",
                                                                 "", 0, SPECIAL_INFO_STAT_SHOTS_FIRED);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The number of enemies Hubert has\nhit with the stunner.",
                                                                 "", 0, SPECIAL_INFO_STAT_ENEMIES_STUNNED);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The number of ammo boxes\nHubert has collected.", "",
                                                                 0, SPECIAL_INFO_STAT_AMMO_PICKED_UP);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The number of times\nHubert has shot water.", "", 0,
                                                                 SPECIAL_INFO_STAT_WATER_SHOT);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The number of levers Hubert has\ntriggered by shooting them.",
                                                                 "", 0, SPECIAL_INFO_STAT_TRIGGERS_SHOT);
    ...
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 ...
                                                                 0, SPECIAL_INFO_STAT_CHECKPOINTS_ACTIVATED);

    msg = "< Page 2";
    button_sound = 10 - 1;
    vector_windows[vector_windows.size() - 1].create_button(15, window_height - back_button_space, "", msg,
                                                            &button_event_open_window_stats_2,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    msg = "Page 2 >";
    button_sound = 11 - 1;
    vector_windows[vector_windows.size() - 1].create_button(window_width - 20 - msg.length() * font.spacing_x,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_stats_2,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
    ...
    y_position = 40;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The total number of times\nHubert has been defeated.",
                                                                 "", 0, SPECIAL_INFO_STAT_DEATHS_TOTAL);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The number of times Hubert has\nbeen defeated by enemies.",
                                                                 "", 0, SPECIAL_INFO_STAT_DEATHS_ENEMIES);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The number of times Hubert has\nbeen defeated by traps.",
                                                                 "", 0, SPECIAL_INFO_STAT_DEATHS_TRAPS);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The number of times\nHubert has drowned.", "", 0,
                                                                 SPECIAL_INFO_STAT_DEATHS_DROWNING);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The number of levels\nHubert has replayed.", "", 0,
                                                                 SPECIAL_INFO_STAT_LEVELS_REPLAYED);

    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position,
                                                                 "The number of times Hubert\nhas moved an item in the inventory.",
                                                                 "", 0, SPECIAL_INFO_STAT_ITEMS_MOVED);

    msg = "< Page 1";
    button_sound = 10 - 1;
    vector_windows[vector_windows.size() - 1].create_button(15, window_height - back_button_space, "", msg,
                                                            &button_event_open_window_stats,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows.push_back(Window((main_window.SCREEN_WIDTH - window_width) / 2,
                                    (main_window.SCREEN_HEIGHT - window_height) / 2, window_width, window_height,
                                    "Achievements", NO_SPECIAL_INPUT));

    for (int menu_x = 0, achievement = 0 * 15; menu_x < 15; menu_x++, achievement++) {
        vector_windows[vector_windows.size() - 1].create_information(15, 40 + 30 * menu_x,
                                                                     achievement_tooltips[achievement], "", 0,
                                                                     SPECIAL_INFO_CHECKBOX_ACHIEVEMENT + achievement);
        vector_windows[vector_windows.size() - 1].create_information(42, 38 + 30 * menu_x,
                                                                     achievement_tooltips[achievement], "", 0,
                                                                     SPECIAL_INFO_ACHIEVEMENT + achievement);
    }

    msg = "< Page 8";
    button_sound = 10 - 1;
    vector_windows[vector_windows.size() - 1].create_button(15, window_height - back_button_space, "", msg,
                                                            &button_event_open_window_achievements_8,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(window_width - 20 - msg.length() * font.spacing_x,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_achievements_2,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    button_sound = 10 - 1;
    vector_windows[vector_windows.size() - 1].create_button(15, window_height - back_button_space, "", msg,
                                                            &button_event_open_window_achievements,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(window_width - 20 - msg.length() * font.spacing_x,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_achievements_3,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(window_width - 20 - msg.length() * font.spacing_x,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_achievements_4,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(window_width - 20 - msg.length() * font.spacing_x,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_achievements_5,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(window_width - 20 - msg.length() * font.spacing_x,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_achievements_6,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(window_width - 20 - msg.length() * font.spacing_x,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_achievements_7,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    msg = "Fullscreen:";
    button_sound = 7 - 1;
    vector_windows[vector_windows.size() - 1].create_information(15, 65, "Toggle fullscreen mode.", msg, 0,
                                                                 NO_SPECIAL_INFO);
    vector_windows[vector_windows.size() - 1].create_information(200, 67, "", "", 0, SPECIAL_INFO_CHECKBOX_FULLSCREEN);
    vector_windows[vector_windows.size() - 1].create_button(200 - 1, 67, "Toggle fullscreen mode.", "  ",
                                                            &button_event_option_fullscreen,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    msg = "Show FPS:";
    button_sound = 11 - 1;
    vector_windows[vector_windows.size() - 1].create_information(15, 95, "Toggle FPS display.", msg, 0,
                                                                 NO_SPECIAL_INFO);
    vector_windows[vector_windows.size() - 1].create_information(200, 97, "", "", 0, SPECIAL_INFO_CHECKBOX_FPS);
    vector_windows[vector_windows.size() - 1].create_button(200 - 1, 97, "Toggle FPS display.", "  ",
                                                            &button_event_option_fps,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    msg = "Hardware Cursor:";
    button_sound = 9 - 1;
    vector_windows[vector_windows.size() - 1].create_information(15, 125,
                                                                 "Try enabling this if\nthe cursor isn't\nvery responsive.",
                                                                 msg, 0, NO_SPECIAL_INFO);
    vector_windows[vector_windows.size() - 1].create_information(200, 127, "", "", 0,
                                                                 SPECIAL_INFO_CHECKBOX_HARDWARE_CURSOR);
    vector_windows[vector_windows.size() - 1].create_button(200 - 1, 127,
                                                            "Try enabling this if\nthe cursor isn't\nvery responsive.",
                                                            "  ", &button_event_option_hardware_cursor,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(375 - 1, 97, "Mute everything.", "  ",
                                                            &button_event_option_mute_global,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    msg = "-";
    button_sound = 8 - 1;
    vector_windows[vector_windows.size() - 1].create_button(315, 125, "Decrease the volume of everything.", msg,
                                                            &button_event_option_volume_down_global,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    msg = "+";
    button_sound = 12 - 1;
    vector_windows[vector_windows.size() - 1].create_button(558, 125, "Increase the volume of everything.", msg,
                                                            &button_event_option_volume_up_global,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    msg = "Mute:";
    button_sound = 10 - 1;
    vector_windows[vector_windows.size() - 1].create_information(315, 190, "Mute sound effects.", msg, 0,
                                                                 NO_SPECIAL_INFO);
    vector_windows[vector_windows.size() - 1].create_information(375, 192, "", "", 0, SPECIAL_INFO_CHECKBOX_MUTE_SOUND);
    vector_windows[vector_windows.size() - 1].create_button(375 - 1, 192, "Mute sound effects.", "  ",
                                                            &button_event_option_mute_sound,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    msg = "-";
    button_sound = 8 - 1;
    vector_windows[vector_windows.size() - 1].create_button(315, 220, "Decrease the volume of sound effects.", msg,
                                                            &button_event_option_volume_down_sound,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    msg = "+";
    button_sound = 10 - 1;
    vector_windows[vector_windows.size() - 1].create_button(558, 220, "Increase the volume of sound effects.", msg,
                                                            &button_event_option_volume_up_sound,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(375 - 1, 287, "Mute the music.", "  ",
                                                            &button_event_option_mute_music,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    msg = "-";
    button_sound = 8 - 1;
    vector_windows[vector_windows.size() - 1].create_button(315, 315, "Decrease the volume of the music.", msg,
                                                            &button_event_option_volume_down_music,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    msg = "+";
    button_sound = 7 - 1;
    vector_windows[vector_windows.size() - 1].create_button(558, 315, "Increase the volume of the music.", msg,
                                                            &button_event_option_volume_up_music,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    msg = "Holiday Cheer:";
    button_sound = 8 - 1;
    vector_windows[vector_windows.size() - 1].create_information(15, 195, "Toggle holiday decorations and effects.",
                                                                 msg, 0, NO_SPECIAL_INFO);
    vector_windows[vector_windows.size() - 1].create_information(200, 197, "", "", 0,
                                                                 SPECIAL_INFO_CHECKBOX_HOLIDAY_CHEER);
    vector_windows[vector_windows.size() - 1].create_button(200 - 1, 197, "Toggle holiday decorations and effects.",
                                                            "  ", &button_event_option_holiday_cheer,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    msg = "World Lighting:";
    button_sound = 12 - 1;
    vector_windows[vector_windows.size() - 1].create_information(15, 225, "Toggle day/night effects on the world map.",
                                                                 msg, 0, NO_SPECIAL_INFO);
    vector_windows[vector_windows.size() - 1].create_information(200, 227, "", "", 0,
                                                                 SPECIAL_INFO_CHECKBOX_TIME_OF_DAY);
    vector_windows[vector_windows.size() - 1].create_button(200 - 1, 227, "Toggle day/night effects on the world map.",
                                                            "  ", &button_event_option_time_of_day,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    msg = "Level Lighting:";
    button_sound = 10 - 1;
    vector_windows[vector_windows.size() - 1].create_information(15, 255, "Toggle day/night effects in levels.", msg, 0,
                                                                 NO_SPECIAL_INFO);
    vector_windows[vector_windows.size() - 1].create_information(200, 257, "", "", 0,
                                                                 SPECIAL_INFO_CHECKBOX_TIME_OF_DAY_LEVELS);
    vector_windows[vector_windows.size() - 1].create_button(200 - 1, 257, "Toggle day/night effects in levels.", "  ",
                                                            &button_event_option_time_of_day_levels,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    msg = "Tips:";
    button_sound = 8 - 1;
    vector_windows[vector_windows.size() - 1].create_information(15, 285, "Toggle tips for new players.", msg, 0,
                                                                 NO_SPECIAL_INFO);
    vector_windows[vector_windows.size() - 1].create_information(200, 287, "", "", 0, SPECIAL_INFO_CHECKBOX_HINTS);
    vector_windows[vector_windows.size() - 1].create_button(200 - 1, 287, "Toggle tips for new players.", "  ",
                                                            &button_event_option_hints,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_information(15, 315, "Toggle game difficulty.", msg, 0,
                                                                 NO_SPECIAL_INFO);
    vector_windows[vector_windows.size() - 1].create_information(15 + x_position, 317, "", "", 0,
                                                                 SPECIAL_INFO_DIFFICULTY);
    vector_windows[vector_windows.size() - 1].create_button(15 + x_position - 1, 317, "Toggle game difficulty.",
                                                            "      ", &button_event_option_difficulty,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(window_width - 20 - msg.length() * font.spacing_x,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_sound_test,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    y_position = 357;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_open_window_options_keys,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg,
                                                            &button_event_open_window_options_keys_1,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg,
                                                            &button_event_open_window_options_keys_2,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg,
                                                            &button_event_open_window_options_keys_3,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    button_sound = 10 - 1;
    vector_windows[vector_windows.size() - 1].create_button(15, window_height - back_button_space, "", msg,
                                                            &button_event_show_data_location,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows.push_back(Window((main_window.SCREEN_WIDTH - window_width) / 2,
                                    (main_window.SCREEN_HEIGHT - window_height) / 2, window_width, window_height,
                                    "Controls - Player 1", NO_SPECIAL_INPUT));
    ...
    vector_windows[vector_windows.size() - 1].create_button(15, y_position, "",
                                                            "                                                   ",
                                                            &button_event_key_left,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    y_position += 25;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position, "", msg, 0, NO_SPECIAL_INFO);
    vector_windows[vector_windows.size() - 1].create_information(145, y_position, "", "", 0,
                                                                 SPECIAL_INFO_KEY_CHANGE_SHOT);
    vector_windows[vector_windows.size() - 1].create_button(15, y_position, "",
                                                            "                                                   ",
                                                            &button_event_key_change_shot,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(15, y_position, "",
                                                            "                                                   ",
                                                            &button_event_key_change_character,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(15, y_position, "",
                                                            "                                                   ",
                                                            &button_event_key_toggle_main_menu,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(15, y_position, "",
                                                            "                                                   ",
                                                            &button_event_key_toggle_inventory,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    button_sound = 10 - 1;
    y_position += 185;
    vector_windows[vector_windows.size() - 1].create_button(10, y_position,
                                                            "Set controls to some\nnice defaults for\nthe keyboard.",
                                                            msg, &button_event_default_keys_keyboard,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position,
                                                            "Set controls to some\nnice defaults for\nthe 360 controller.",
                                                            msg, &button_event_default_keys_joystick_0,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE, -1);
    ...
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position,
                                                            "Set controls to some\nnice defaults for\nthe 360 controller.",
                                                            msg, &button_event_default_keys_joystick_1,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE, -1);
    ...
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position,
                                                            "Set controls to some\nnice defaults for\nthe 360 controller.",
                                                            msg, &button_event_default_keys_joystick_2,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE, -1);
    ...
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position,
                                                            "Set controls to some\nnice defaults for\nthe 360 controller.",
                                                            msg, &button_event_default_keys_joystick_3,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE, -1);
    ...
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_options,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows.push_back(Window((main_window.SCREEN_WIDTH - window_width) / 2,
                                    (main_window.SCREEN_HEIGHT - window_height) / 2, window_width, window_height,
                                    "Controls - Player 2", NO_SPECIAL_INPUT));
    ...
    vector_windows[vector_windows.size() - 1].create_button(15, y_position, "",
                                                            "                                                   ",
                                                            &button_event_key_1_change_shot,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(10, y_position,
                                                            "Set controls to some\nnice defaults for\nthe keyboard.",
                                                            msg, &button_event_default_keys_1_keyboard,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows.push_back(Window((main_window.SCREEN_WIDTH - window_width) / 2,
                                    (main_window.SCREEN_HEIGHT - window_height) / 2, window_width, window_height,
                                    "Controls - Player 3", NO_SPECIAL_INPUT));
    ...
    vector_windows[vector_windows.size() - 1].create_button(15, y_position, "",
                                                            "                                                   ",
                                                            &button_event_key_2_change_shot,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(10, y_position,
                                                            "Set controls to some\nnice defaults for\nthe keyboard.",
                                                            msg, &button_event_default_keys_2_keyboard,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows.push_back(Window((main_window.SCREEN_WIDTH - window_width) / 2,
                                    (main_window.SCREEN_HEIGHT - window_height) / 2, window_width, window_height,
                                    "Controls - Player 4", NO_SPECIAL_INPUT));
    ...
    vector_windows[vector_windows.size() - 1].create_button(15, y_position, "",
                                                            "                                                   ",
                                                            &button_event_key_3_change_shot,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_INVISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(10, y_position,
                                                            "Set controls to some\nnice defaults for\nthe keyboard.",
                                                            msg, &button_event_default_keys_3_keyboard,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows.push_back(Window((main_window.SCREEN_WIDTH - window_width) / 2,
                                    (main_window.SCREEN_HEIGHT - window_height) / 2, window_width, window_height,
                                    "About", NO_SPECIAL_INPUT));

    msg = "Hubert's Island Adventure:";
    y_position = 40;
    vector_windows[vector_windows.size() - 1].create_information((window_width - (msg.length() * font.spacing_x)) / 2,
                                                                 y_position, "", msg, 0, NO_SPECIAL_INFO);
    ...
    vector_windows[vector_windows.size() - 1].create_information(window_width - image.logo_cheese_and_bacon.w - 15, 45,
                                                                 "", "", &image.logo_cheese_and_bacon, NO_SPECIAL_INFO);

    msg =
        "What are we about? Cheese, bacon, or games? We believe that a company\ncan be about all three. Here are some more things we believe in:\n\n";
    msg +=
        "We believe in gameplay over snazzy graphics. We work to create games\nthat will be enjoyable for years to come, not just until the next cool\ntechnology comes out. That is not to say that we dislike fancy\ngraphics, awesome music, etc., but gameplay is our top priority.\n\n";
    ...
    vector_windows.push_back(Window((main_window.SCREEN_WIDTH - window_width) / 2,
                                    (main_window.SCREEN_HEIGHT - window_height) / 2, window_width, window_height,
                                    "Credits", NO_SPECIAL_INPUT));

    msg = "Cheese and Bacon Games";
    vector_windows[vector_windows.size() - 1].create_information((window_width - msg.length() * font.spacing_x) / 2, 40,
                                                                 "", msg, 0, NO_SPECIAL_INFO);
    ...
    y_position = 100;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position, "", "", &image.sprite_sheet_player,
                                                                 NO_SPECIAL_INFO, &sprites_player_idle_right[0]);
    msg = "Hubert,";
    vector_windows[vector_windows.size() - 1].create_information(20 + sprites_player_idle_right[0].w, y_position - 5,
                                                                 "", msg, 0, NO_SPECIAL_INFO, 0, name_color);
    ...
    y_position += 60;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position, "", "",
                                                                 &image.sprite_sheet_character_slime_o, NO_SPECIAL_INFO,
                                                                 &sprites_player_idle_right[0]);
    msg = "Slime-O";
    vector_windows[vector_windows.size() - 1].create_information(20 + sprites_player_idle_right[0].w, y_position - 5,
                                                                 "", msg, 0, NO_SPECIAL_INFO, 0, name_color);
    msg =
        "        is heavier and slower than Hubert.\nHe is an excellent choice if you are having\na hard time controlling Hubert.";
    vector_windows[vector_windows.size() - 1].create_information(20 + sprites_player_idle_right[0].w, y_position - 5,
                                                                 "", msg, 0, NO_SPECIAL_INFO);

    y_position += 90;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position, "", "",
                                                                 &image.sprite_sheet_character_sketch, NO_SPECIAL_INFO,
                                                                 &sprites_player_idle_right[0]);
    msg = "Sketch";
    vector_windows[vector_windows.size() - 1].create_information(20 + sprites_player_idle_right[0].w, y_position - 5,
                                                                 "", msg, 0, NO_SPECIAL_INFO, 0, name_color);
    ...
    y_position += 60;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position, "", "",
                                                                 &image.sprite_sheet_character_penny, NO_SPECIAL_INFO,
                                                                 &sprites_player_idle_right[0]);
    msg = "Penny";
    vector_windows[vector_windows.size() - 1].create_information(20 + sprites_player_idle_right[0].w, y_position - 5,
                                                                 "", msg, 0, NO_SPECIAL_INFO, 0, name_color);
    ...
    button_sound = 10 - 1;
    vector_windows[vector_windows.size() - 1].create_button(15, window_height - back_button_space, "", msg,
                                                            &button_event_open_window_help_8,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(window_width - 20 - msg.length() * font.spacing_x,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_help_2,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_information(15, y_position, "", "", &image.sprite_sheet_items,
                                                                 NO_SPECIAL_INFO, ptr_item_rect);
    msg = "Leaf.";
    vector_windows[vector_windows.size() - 1].create_information(20 + ptr_item_rect->w, y_position - 5, "", msg, 0,
                                                                 NO_SPECIAL_INFO, 0, name_color);
    ...
    vector_windows[vector_windows.size() - 1].create_button(window_width - 20 - msg.length() * font.spacing_x,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_help_3,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    for (int type = NPC_SLIME, i = 0; type <= NPC_ARCHER; type++, i++) {
        if (type != NPC_REPLICATOR && type != NPC_LASER_SPINNER && type != NPC_PENGUIN_HARMLESS &&
            ...
            vector_windows[vector_windows.size() - 1].create_information(x_position, y_position, "", "",
                                                                         return_npc_image(type), NO_SPECIAL_INFO,
                                                                         ptr_rect);
            msg = return_npc_name(type) + ".";
            vector_windows[vector_windows.size() - 1].create_information(x_position + 5 + ptr_rect->w, y_position - 5,
                                                                         "", msg, 0, NO_SPECIAL_INFO, 0, name_color);
    ...
    vector_windows[vector_windows.size() - 1].create_button(window_width - 20 - msg.length() * font.spacing_x,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_help_4,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button(window_width - 20 - msg.length() * font.spacing_x,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_help_5,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    for (int type = NPC_FIREBALL, i = 0; type <= NPC_STARFISH; type++, i++) {
        if (type != NPC_FIREBALL_SHOOTER_DOWN && type != NPC_FIREBALL_SHOOTER_LEFT &&
            ...
            type != NPC_BOUNCING_COW && type != NPC_BOUNCING_BALL && type != NPC_SPHINX_LEFT &&
            type != NPC_SPHINX_RIGHT) {
            SDL_Rect* ptr_rect = NULL;
    ...
    vector_windows[vector_windows.size() - 1].create_button(window_width - 20 - msg.length() * font.spacing_x,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_help_6,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_information(200, y_position, "", "", return_npc_image(boss_type),
                                                                 NO_SPECIAL_INFO, ptr_boss_rect);

    y_position = 160;
    boss_type = NPC_BOSS_HAUNTED_HOUSE;
    ptr_boss_rect = &SPRITES_NPC[boss_type].fly_left[0];
    vector_windows[vector_windows.size() - 1].create_information(window_width - ptr_boss_rect->w - 200, y_position, "",
                                                                 "", return_npc_image(boss_type), NO_SPECIAL_INFO,
                                                                 ptr_boss_rect);
    ...
    vector_windows[vector_windows.size() - 1].create_information(355, y_position, "", "", return_npc_image(boss_type),
                                                                 NO_SPECIAL_INFO, ptr_boss_rect);
    ...
    vector_windows[vector_windows.size() - 1].create_button(window_width - 20 - msg.length() * font.spacing_x,
                                                            window_height - back_button_space, "", msg,
                                                            &button_event_open_window_help_7,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    y_position += 40;
    vector_windows[vector_windows.size() - 1].create_information((window_width - (msg.length() * font.spacing_x)) / 2,
                                                                 y_position, "", msg, 0, NO_SPECIAL_INFO, NULL,
                                                                 alt_color);
    ...
    for (int i = 12, n = 0, letter = 67; i > 0; i--, n++) {
        ...
        msg += " \n   ";
        button_sound = i - 1;
        vector_windows[vector_windows.size() - 1].create_button(80 + n * 20 + n * 3 * font.spacing_x, 60, "", msg,
                                                                &button_event_do_nothing, NULL,
                                                                &sound_system.button_event_fire[button_sound],
                                                                BUTTON_VISIBLE);
        msg = (char) letter;
        vector_windows[vector_windows.size() - 1].create_information(80 + n * 20 + n * 3 * font.spacing_x +
                                                                     font.spacing_x, 140, "", msg, 0, NO_SPECIAL_INFO);
    ...
    vector_windows.push_back(Window((main_window.SCREEN_WIDTH - window_width) / 2,
                                    (main_window.SCREEN_HEIGHT - window_height) / 2, window_width, window_height,
                                    "Get the full version!", NO_SPECIAL_INPUT, &image.loading_screen_main));
    ...
    button_sound = 7 - 1;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            window_height - back_button_space * 2, "", msg,
                                                            &button_event_buy_game,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows.push_back(Window((main_window.SCREEN_WIDTH - window_width) / 2,
                                    (main_window.SCREEN_HEIGHT - window_height) / 2, window_width, window_height,
                                    "Select Game Mode", NO_SPECIAL_INPUT));

    msg = "Singleplayer Adventure";
    y_position = 40;
    button_sound = 7 - 1;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_start_game_sp_adventure,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg,
                                                            &button_event_open_window_setup_sp_survival,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    button_sound = 7 - 1;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_mp_prepare_survival,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    button_sound = 8 - 1;
    vector_windows[vector_windows.size() - 1].create_button((window_width - (msg.length() * font.spacing_x)) / 2,
                                                            y_position, "", msg, &button_event_mp_prepare_adventure,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    vector_windows.push_back(Window((main_window.SCREEN_WIDTH - window_width) / 2,
                                    (main_window.SCREEN_HEIGHT - window_height) / 2, window_width, window_height,
                                    "Multiplayer Setup", NO_SPECIAL_INPUT));

    msg = "Players: 1";
    y_position = 40;
    x_position = (window_width - (msg.length() * font.spacing_x)) / 2;
    vector_windows[vector_windows.size() - 1].create_information(x_position, y_position, "", msg, 0,
                                                                 SPECIAL_INFO_MP_PLAYER_COUNT);

    msg = ">";
    button_sound = 7 - 1;
    vector_windows[vector_windows.size() - 1].create_button(x_position + font.spacing_x * 11, y_position, "", msg,
                                                            &button_event_mp_players_up,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    msg = "<";
    button_sound = 6 - 1;
    vector_windows[vector_windows.size() - 1].create_button(x_position - font.spacing_x * 2, y_position, "", msg,
                                                            &button_event_mp_players_down,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    ...
    button_sound = 8 - 1;
    y_position += 3;
    vector_windows[vector_windows.size() - 1].create_button(70, y_position, "", msg,
                                                            &button_event_mp_character_toggle_0,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    y_position += 30;
    vector_windows[vector_windows.size() - 1].create_information(15, y_position, "", "", 0,
    ...
    y_position += 3;
    vector_windows[vector_windows.size() - 1].create_button(70, y_position, "", msg,
                                                            &button_event_mp_character_toggle_1,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    y_position += 30;
    ...
    y_position += 3;
    vector_windows[vector_windows.size() - 1].create_button(70, y_position, "", msg,
                                                            &button_event_mp_character_toggle_2,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    y_position += 30;
    ...
    y_position += 3;
    vector_windows[vector_windows.size() - 1].create_button(70, y_position, "", msg,
                                                            &button_event_mp_character_toggle_3,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    y_position += 30;
    ...
    msg = "^";
    button_sound = 3 - 1;
    vector_windows[vector_windows.size() - 1].create_button(200, y_position, "", msg, &button_event_mp_ai_toggle_1,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    y_position += 30;
    ...
    msg = "^";
    button_sound = 1 - 1;
    vector_windows[vector_windows.size() - 1].create_button(200, y_position, "", msg, &button_event_mp_ai_toggle_2,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    y_position += 30;
    ...
    msg = "^";
    button_sound = 2 - 1;
    vector_windows[vector_windows.size() - 1].create_button(200, y_position, "", msg, &button_event_mp_ai_toggle_3,
                                                            &sound_system.button_mouse_over[button_sound],
                                                            &sound_system.button_event_fire[button_sound],
                                                            BUTTON_VISIBLE);
    y_position += 30;
