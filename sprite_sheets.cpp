...
void create_sprite_sheets_npcs () {
    ...
    for (short i = 0; i < NPC_SPRITE_COUNTS[NPC_LASER_SPINNER].special_attack_sprites; i++) {
        ...
        SPRITES_NPC[NPC_LASER_SPINNER].special_attack_right[i].x = i *
                                                                   NPC_SPRITE_COUNTS[NPC_LASER_SPINNER].special_width;
        ...
        SPRITES_NPC[NPC_LASER_SPINNER].special_attack_left[i].x = i *
                                                                  NPC_SPRITE_COUNTS[NPC_LASER_SPINNER].special_width;
    ...
    for (short i = 0; i < NPC_SPRITE_COUNTS[NPC_SCARECROW].special_attack_sprites; i++) {
        ...
        SPRITES_NPC[NPC_SCARECROW].special_attack_left[i].y = NPC_SPRITE_COUNTS[NPC_SCARECROW].height +
                                                              NPC_SPRITE_COUNTS[NPC_SCARECROW].special_height;
    ...
    for (short i = 0; i < NPC_SPRITE_COUNTS[NPC_SCARECROW].dead_sprites; i++) {
        ...
        SPRITES_NPC[NPC_SCARECROW].dead[i].y = NPC_SPRITE_COUNTS[NPC_SCARECROW].height +
                                               NPC_SPRITE_COUNTS[NPC_SCARECROW].special_height * 2;
    ...
    for (short i = 0; i < NPC_SPRITE_COUNTS[NPC_CAT].special_attack_sprites; i++) {
        ...
        SPRITES_NPC[NPC_CAT].special_attack_left[i].y = NPC_SPRITE_COUNTS[NPC_CAT].height * 4 +
                                                        NPC_SPRITE_COUNTS[NPC_CAT].special_height;
    ...
    for (short i = 0; i < NPC_SPRITE_COUNTS[NPC_CAT].dead_sprites; i++) {
        ...
        SPRITES_NPC[NPC_CAT].dead[i].y = NPC_SPRITE_COUNTS[NPC_CAT].height * 4 +
                                         NPC_SPRITE_COUNTS[NPC_CAT].special_height * 2;
    ...
    for (short i = 0; i < NPC_SPRITE_COUNTS[NPC_EAGLE].special_attack_sprites; i++) {
        ...
        SPRITES_NPC[NPC_EAGLE].special_attack_left[i].y = NPC_SPRITE_COUNTS[NPC_EAGLE].height * 2 +
                                                          NPC_SPRITE_COUNTS[NPC_EAGLE].special_height;
    ...
    for (short i = 0; i < NPC_SPRITE_COUNTS[NPC_EAGLE].dead_sprites; i++) {
        ...
        SPRITES_NPC[NPC_EAGLE].dead[i].y = NPC_SPRITE_COUNTS[NPC_EAGLE].height * 2 +
                                           NPC_SPRITE_COUNTS[NPC_EAGLE].special_height * 2;
    ...
    for (short i = 0; i < NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_LEFT].special_attack_sprites; i++) {
        ...
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_LEFT].special_attack_right[i].w =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_LEFT].special_width;
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_LEFT].special_attack_right[i].h =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_LEFT].special_height;
        ...
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_LEFT].special_attack_left[i].w =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_LEFT].special_width;
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_LEFT].special_attack_left[i].h =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_LEFT].special_height;
    }
    ...
    for (short i = 0; i < NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_RIGHT].walk_sprites; i++) {
        ...
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_RIGHT].walk_right[i].x = i *
                                                                  NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_RIGHT].width;
        ...
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_RIGHT].walk_left[i].x = i *
                                                                 NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_RIGHT].width;
    ...
    for (short i = 0; i < NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_RIGHT].special_attack_sprites; i++) {
        ...
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_RIGHT].special_attack_right[i].w =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_RIGHT].special_width;
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_RIGHT].special_attack_right[i].h =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_RIGHT].special_height;
        ...
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_RIGHT].special_attack_left[i].w =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_RIGHT].special_width;
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_RIGHT].special_attack_left[i].h =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_RIGHT].special_height;
    }
    ...
    for (short i = 0; i < NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_UP].special_attack_sprites; i++) {
        ...
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_UP].special_attack_right[i].w =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_UP].special_width;
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_UP].special_attack_right[i].h =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_UP].special_height;
        ...
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_UP].special_attack_left[i].w =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_UP].special_width;
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_UP].special_attack_left[i].h =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_UP].special_height;
    }
    ...
    for (short i = 0; i < NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_DOWN].special_attack_sprites; i++) {
        ...
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_DOWN].special_attack_right[i].w =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_DOWN].special_width;
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_DOWN].special_attack_right[i].h =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_DOWN].special_height;
        ...
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_DOWN].special_attack_left[i].w =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_DOWN].special_width;
        SPRITES_NPC[NPC_FIREBALL_SHOOTER_DOWN].special_attack_left[i].h =
            NPC_SPRITE_COUNTS[NPC_FIREBALL_SHOOTER_DOWN].special_height;
    }
    ...
    for (short i = 0; i < NPC_SPRITE_COUNTS[NPC_MECHSUIT_MOUSE].special_attack_sprites; i++) {
        ...
        SPRITES_NPC[NPC_MECHSUIT_MOUSE].special_attack_right[i].x = i *
                                                                    NPC_SPRITE_COUNTS[NPC_MECHSUIT_MOUSE].special_width;
        ...
        SPRITES_NPC[NPC_MECHSUIT_MOUSE].special_attack_right[i].h =
            NPC_SPRITE_COUNTS[NPC_MECHSUIT_MOUSE].special_height;

        SPRITES_NPC[NPC_MECHSUIT_MOUSE].special_attack_left.push_back(SDL_Rect());
        SPRITES_NPC[NPC_MECHSUIT_MOUSE].special_attack_left[i].x = i *
                                                                   NPC_SPRITE_COUNTS[NPC_MECHSUIT_MOUSE].special_width;
