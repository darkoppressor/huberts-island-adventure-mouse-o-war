...
void button_event_default_keys_joystick(int player_index,int joystick_num){
    if(player_index==-1){
        ...
        player.keys.push_back(Input_Data());
        player.keys[player.keys.size()-1].set_joy_hat(joystick_num,0,8);
        player.keys.push_back(Input_Data());
        player.keys[player.keys.size()-1].set_joy_hat(joystick_num,0,1);
        player.keys.push_back(Input_Data());
        player.keys[player.keys.size()-1].set_joy_hat(joystick_num,0,2);
        player.keys.push_back(Input_Data());
        player.keys[player.keys.size()-1].set_joy_hat(joystick_num,0,4);
        player.keys.push_back(Input_Data());
        ...
        player.mp_keys[player_index].push_back(Input_Data());
        player.mp_keys[player_index][player.mp_keys[player_index].size()-1].set_joy_hat(joystick_num,0,8);
        player.mp_keys[player_index].push_back(Input_Data());
        player.mp_keys[player_index][player.mp_keys[player_index].size()-1].set_joy_hat(joystick_num,0,1);
        player.mp_keys[player_index].push_back(Input_Data());
        player.mp_keys[player_index][player.mp_keys[player_index].size()-1].set_joy_hat(joystick_num,0,2);
        player.mp_keys[player_index].push_back(Input_Data());
        player.mp_keys[player_index][player.mp_keys[player_index].size()-1].set_joy_hat(joystick_num,0,4);
        player.mp_keys[player_index].push_back(Input_Data());
