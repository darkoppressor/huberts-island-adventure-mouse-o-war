...
class Actor {
    ...
    public:
        ...
        void handle_collision_solid(double passed_x, double passed_y, double passed_w, double passed_h, short solidity,
                                    short passed_type);
        ...
        // Current direction for shooting purposes. When multiple keys are held, the priorities are different for
        // shooting than for moving.
        short shoot_state;
        ...
        // The below two variables are used to determine if the actor has walked off of a ledge, and should begin
        // falling.
        ...
        // In other words, if the actor is still in water, and doesn't hit the up or down directional keys, the actor
        // will slowly accelerate upwards until reaching this speed.
        // The actor can continue to accelerate faster on his own by pressing the up directional key, up to
        // max_swim_speed.
        double max_buoyancy;
        ...
        // While the timer is running, the actor's buoyancy is increased so they actor floats quickly to the top of the
        // water when he first jumps in.
        ...
        // Simply tells us whether or not the actor is currently in the air. If so, the actor's y coordinate will be
        // incremented by air_velocity.
        bool IN_AIR;
