...
short return_gui_color (short holiday_ident, short color_number) {
    ...
    if (player.option_holiday_cheer) {
        if (holiday_ident == HOLIDAY_NEW_YEARS_DAY) {} else if (holiday_ident ==
                                                                HOLIDAY_VALENTINES) {} else if (holiday_ident ==
                                                                                                HOLIDAY_ST_PATRICKS) {}
        else if (holiday_ident == HOLIDAY_EASTER) {} else if (holiday_ident == HOLIDAY_INDEPENDENCE) {
        ...
        } else if (holiday_ident == HOLIDAY_HALLOWEEN) {} else if (holiday_ident ==
                                                                   HOLIDAY_THANKSGIVING) {} else if (holiday_ident ==
                                                                                                     HOLIDAY_CHRISTMAS)
        {
            colors[0] = COLOR_DARK_RED;
