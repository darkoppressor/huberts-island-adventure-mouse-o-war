...
Window_Upgrades::Window_Upgrades (short get_x, short get_y, short get_w, short get_h, string get_title) {
    ...
    button_sound = 12 - 1;
    create_button(16, h - back_button_space, "", msg, &button_event_close_window,
    ...
    create_button(w - (msg.length() * font.spacing_x) - 16, h - back_button_space, "", msg,
                  &button_event_upgrade_toggle, &sound_system.button_mouse_over[button_sound],
        ...
        switch (event.type) {
            ...
            case SDL_MOUSEBUTTONUP:
                ...
                if (event.button.button == SDL_BUTTON_LEFT) {
                    ...
                    if (player.mouse_allowed()) {
                        for (int i = upgrade_list_display_position, n = 0; i < upgrade_list_display_position + 18;
                             i++, n++) {
...
void Window_Upgrades::render () {
    if (on) {
        ...
        font.show(x + (w - upgrade_string.length() * font.spacing_x) / 2, 40, upgrade_string,
        ...
        font.show(x + (w - upgrade_string.length() * font.spacing_x) / 2, 70, upgrade_string,
                  return_gui_color(holiday, 3));
        ...
        for (int i = upgrade_list_display_position, n = 0; i < upgrade_list_display_position + 18; i++, n++) {
            ...
            if (i < upgrades.size()) {
                ...
                font.show(x + (w - upgrade.length() * font.spacing_x) / 2 + 2,
                          70 + font.spacing_y * 2 + n * font.spacing_y + 2, upgrade, COLOR_BLACK);
                font.show(x + (w - upgrade.length() * font.spacing_x) / 2, 70 + font.spacing_y * 2 + n * font.spacing_y,
                          upgrade, return_gui_color(holiday, 3));
            }
        }
