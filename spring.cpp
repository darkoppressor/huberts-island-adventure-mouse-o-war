...
void Spring::render (bool mirrored) {
    if (x >= player.camera_x - SPRING_W && x <= player.camera_x + player.camera_w && y >= player.camera_y - SPRING_H &&
        ...
        render_sprite((int) ((int) render_x - (int) player.camera_x), (int) ((int) render_y - (int) player.camera_y),
                      image.sprite_sheet_spring, &sprites_spring[frame], 1.0, 1.0, 1.0, angle);
