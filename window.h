...
class Window {
    ...
    public:
        ...
        Window (short get_x, short get_y, short get_w, short get_h, std::string get_title, short get_special_input,
                image_data* get_background_image = NULL);
        ...
        // Create a new button.
        void create_button(short b_x, short b_y, std::string b_tooltip_text, std::string b_text,
                           void (*b_event_function) (Window*, int), sound_data* get_mouse_over_sound,
                           sound_data* get_event_fire_sound, bool get_invisible, int get_special_data = -1,
                           bool get_enabled = BUTTON_ENABLED);

        // Create an information piece.
        void create_information(short get_x, short get_y, std::string get_tooltip_text, std::string get_text,
                                image_data* get_info_image, short get_special_info, SDL_Rect* get_info_sprite_sheet = 0,
                                short get_text_color = COLOR_RAINBOW, short get_font_type = 0);
