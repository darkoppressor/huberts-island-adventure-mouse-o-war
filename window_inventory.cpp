        ...
        switch (event.type) {
            ...
            case SDL_MOUSEBUTTONDOWN:
                ...
                if (event.button.button == SDL_BUTTON_LEFT) {
                    ...
                    else if (!button_clicked && player.dragged_item.size() == 0 && collision_check(mouse_x, mouse_y, 2,
                                                                                                   2, x, y, w, h)) {
                        ...
                        if (slot_clicked != -1) {
                            for (int i = 0; i < player.inventory.size(); i++) {
                                if (player.inventory[i].slot == slot_clicked) {
                                    ...
                                    // Set this item to slot -1, meaning it is being dragged and is not to be displayed
                                    // in any inventory window slot.
...
void Window_Inventory::display_dragged_item () {
    ...
    if (player.dragged_item.size() > 0) {
        ...
        if (player.dragged_item[0].type == ITEM_SWIMMING_GEAR) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_swimming_gear[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_swimming_gear[0]);
        } else if (player.dragged_item[0].type == ITEM_KEY_RED) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_key_red[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_key_red[0]);
        } else if (player.dragged_item[0].type == ITEM_KEY_BLUE) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_key_blue[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_key_blue[0]);
        } else if (player.dragged_item[0].type == ITEM_KEY_GREEN) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_key_green[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_key_green[0]);
        } else if (player.dragged_item[0].type == ITEM_KEY_YELLOW) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_key_yellow[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_key_yellow[0]);
        } else if (player.dragged_item[0].type == ITEM_KEY_ORANGE) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_key_orange[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_key_orange[0]);
        } else if (player.dragged_item[0].type == ITEM_KEY_PURPLE) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_key_purple[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_key_purple[0]);
        } else if (player.dragged_item[0].type == ITEM_TOWEL) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_towel[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_towel[0]);
        } else if (player.dragged_item[0].type == ITEM_KEY_GRAY) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_key_gray[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_key_gray[0]);
        } else if (player.dragged_item[0].type == ITEM_KEY_BROWN) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_key_brown[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_key_brown[0]);
        } else if (player.dragged_item[0].type == ITEM_KEY_BLACK) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_key_black[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_key_black[0]);
        } else if (player.dragged_item[0].type == ITEM_KEY_PINK) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_key_pink[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_key_pink[0]);
        } else if (player.dragged_item[0].type == ITEM_KEY_CYAN) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_key_cyan[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_key_cyan[0]);
        } else if (player.dragged_item[0].type == ITEM_SINK) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_sink[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_sink[0]);
        } else if (player.dragged_item[0].type == ITEM_SUIT_DEADLY_WATER) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_suit_deadly_water[0], 1.0, 1.0, 1.0, 0.0,
                          COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_suit_deadly_water[0]);
        } else if (player.dragged_item[0].type == ITEM_SUIT_SHARP) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_suit_sharp[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_suit_sharp[0]);
        } else if (player.dragged_item[0].type == ITEM_SUIT_BANANA) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_suit_banana[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_suit_banana[0]);
        } else if (player.dragged_item[0].type == ITEM_SHOT_HOMING) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_shot_homing[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_shot_homing[0]);
        } else if (player.dragged_item[0].type == ITEM_TRANSLATOR) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_translator[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_translator[0]);
        } else if (player.dragged_item[0].type == ITEM_J_WING) {
            render_sprite(mouse_x - player.dragged_item[0].offset_x + 2, mouse_y - player.dragged_item[0].offset_y + 2,
                          image.sprite_sheet_items, &sprites_item_j_wing[0], 1.0, 1.0, 1.0, 0.0, COLOR_BLACK);
            render_sprite(mouse_x - player.dragged_item[0].offset_x, mouse_y - player.dragged_item[0].offset_y,
                          image.sprite_sheet_items, &sprites_item_j_wing[0]);
        }
    }
}
...
moused_slot Window_Inventory::determine_moused_slot (int mouse_x, int mouse_y) {
    ...
    for (short slot_x = 0; slot_x < 10; slot_x++) {
        for (short slot_y = 0; slot_y < 10; slot_y++) {
            if (collision_check(mouse_x, mouse_y, 2, 2, x + slots[slot_x][slot_y].x, y + slots[slot_x][slot_y].y,
                                slot_w, slot_h)) {
